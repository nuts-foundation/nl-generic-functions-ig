...
The NVI API is defined using OpenAPI 3.0.2 specification (see `nvi_openapi.yaml`). The API provides a straightforward interface for managing the network of involved care providers using standard REST operations.
